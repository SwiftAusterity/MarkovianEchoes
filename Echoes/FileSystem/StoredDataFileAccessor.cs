...
{
    public class StoredDataFileAccessor : FileAccessor
    {
        /// <summary>
        ...
        public StoredDataFileAccessor(IHostingEnvironment hostingEnvironment, FileLogger logger) : base(hostingEnvironment.ContentRootPath, logger) { }
